...
def evaluate_regex(candidate:str,
                 regex:str)->list:
    """
...
def get_regex_proximity(word1:str,
                    word2:str,
                    max_distance:int,
                    direction:str='centre') -> str:
    """
...
def string_search(candidate:str,
    ...
    Returns:
        list or bool: If return_bool is False, returns a list of tuples, where each tuple contains the matched substring and its start and end indices.
