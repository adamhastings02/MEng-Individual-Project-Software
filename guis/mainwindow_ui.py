...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.but_variables.setGeometry(QtCore.QRect(180, 230, 101, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.but_custom.setGeometry(QtCore.QRect(322, 230, 111, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.but_filtering.setGeometry(QtCore.QRect(30, 230, 111, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.but_prepro = QtWidgets.QPushButton(parent=self.centralwidget)
        self.but_prepro.setGeometry(QtCore.QRect(140, 270, 181, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.but_prepro.setFont(font)
        self.but_prepro.setObjectName("but_prepro")
        self.indicator_led = QtWidgets.QProgressBar(parent=self.centralwidget)
        self.indicator_led.setGeometry(QtCore.QRect(900, 410, 21, 23))
        self.indicator_led.setAutoFillBackground(False)
        self.indicator_led.setStyleSheet("")
        self.indicator_led.setProperty("value", 0)
        self.indicator_led.setTextVisible(False)
        self.indicator_led.setObjectName("indicator_led")
        self.label = QtWidgets.QLabel(parent=self.centralwidget)
        self.label.setGeometry(QtCore.QRect(820, 410, 71, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.but_filtering.setText(_translate("MainWindow", "Preview Data"))
        ...
        self.but_prepro.setText(_translate("MainWindow", "Preprocessing Options"))
        self.label.setText(_translate("MainWindow", "Certainty:"))
